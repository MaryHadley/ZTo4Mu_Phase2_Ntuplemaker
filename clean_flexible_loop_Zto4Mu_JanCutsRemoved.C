...
//   bool doMCTruthMatching = false;
   ...
   if (!doMCTruthMatching){
     std::cout << "NOT checking whether an event is a Z to 4 muon event at truth level! You are probably running on data!" << std::endl; 
     std::cout << "//////////////////////////////////////////////////////////////////////////////////////////////////////" << std::endl;
   }
   
   if (doMCTruthMatching){
     std::cout << "CHECKING whether an event is a Z to 4 muon event at truth level! Make sure you are running on MC!" << std::endl;
     std::cout << "/////////////////////////////////////////////////////////////////////////////////////////////////" << std::endl;
   }
...
//    }
  ...
  TFile *ntuple = new TFile("ntuple_ZTo4Mu_2016.root", "RECREATE");
  TTree *aux;
  ...
  for(int iEntry=0; iEntry<entries; iEntry++) {
   ...
   //   std::cout << "Processed  " << eventCounter << "  Events" << std::endl; 
    ...
    if (doMCTruthMatching){
      if (TREE->truth_eventHasZTo4Mu == 0){
        continue;
      }
    }
